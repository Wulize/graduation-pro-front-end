  ...
  <div class="sight-wrapper">
    <div class="sight-catagory">
      <div class="sight-list">
        <div :class="['all-sights',styleList.ifListOneStyleNormal ? 'normal-div' : 'selected-div']" @click="getAllSights">全部景点</div>
        <div :class="['child-sights',styleList.ifListTwoStyleNormal ? 'normal-div' : 'selected-div']" @click="getChildSights">亲子游</div>
        <div :class="['night-sights',styleList.ifListThreeStyleNormal ? 'normal-div' : 'selected-div']" @click="getNightSights">夜·厦门</div>
        <div :class="['museum-sights',styleList.ifListFourStyleNormal ? 'normal-div' : 'selected-div']" @click="getMuseumSights">博物馆</div>
        <div :class="['cat-sights',styleList.ifListFiveStyleNormal ? 'normal-div' : 'selected-div']" @click="getCatSights">撸猫集中地</div>
        <div :class="['photo-sights',styleList.ifListSixStyleNormal ? 'normal-div' : 'selected-div']" @click="getPhotoSights">拍照好去处</div>
      </div>
...
export default class extends Vue {
  ...
  public toSightInfo(sightName: string, type: number = 0): void {
    // 跳转到景点详情
    ;(this as any).$getSight
      .get('/getSightInfo', { sightName })
      .then((data: any) => {
  ...
  public getSights(route: string, from: number = 0): void {
    // 获取景点API
    ;(this as any).$getSight
      .get(route, { currentPage: this.currentPage })
      .then((data: any) => {
