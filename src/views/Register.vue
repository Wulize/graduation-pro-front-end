  ...
  <div class="login-wrapper">
    ...
    <el-form ref="form" :model="form" :rules="rules" class="input-wrapper">
      <el-form-item prop="userEmail">
        <el-input v-model="form.userEmail" placeholder="请输入您的邮箱" class="user-input"></el-input>
      </el-form-item>
      <el-form-item prop="userName">
        <el-input v-model="form.userName" placeholder="请输入您的用户名"></el-input>
      </el-form-item>
      <el-form-item prop="userCode1">
        <el-input v-model="form.userCode1" placeholder="请输入您的密码" showPassword></el-input>
      </el-form-item>
      <el-form-item prop="userCode2">
        <el-input v-model="form.userCode2" placeholder="请再次输入您的密码" showPassword>
        </el-input>
      </el-form-item>
      <el-form-item id="code-wrapper" prop="userValidation">
        <el-input v-model="form.userValidation" placeholder="请输入验证码"></el-input>
      ...
      <div>
        <el-button type="primary" :disabled="ifConfirmForbidden" @click="commit">
          确定
        </el-button>
      </div>
    </el-form>
